...
const (
	...
	OP_CLOSURE;		OP_VARARG;		OP_EXTRARAG
)
...
const (
	...
	OpArgK			// argument is a constant or regsiter/constant
)
...
var opcodes = []opcode {
	...
	opcode{0, 1, OpArgR, OpArgN, IAsBx, "JMP    " },
	opcode{0, 1, OpArgK, OpArgK, IABC, "EQ      " },
	opcode{0, 1, OpArgK, OpArgK, IABC, "LT      " },
	opcode{0, 1, OpArgK, OpArgK, IABC, "LE      " },
	opcode{0, 1, OpArgN, OpArgU, IABC, "TEST    " },
	opcode{0, 1, OpArgR, OpArgU, IABC, "TESTSET " },
	opcode{0, 1, OpArgU, OpArgU, IABC, "CALL    " },
	opcode{0, 1, OpArgU, OpArgU, IABC, "TAILCALL" },
	opcode{0, 1, OpArgU, OpArgN, IABC, "RETURN  " },
	opcode{0, 1, OpArgR, OpArgN, IABC, "FORLOOP " },
	opcode{0, 1, OpArgR, OpArgN, IABC, "FORPREP " },
	opcode{0, 1, OpArgN, OpArgU, IABC, "TFORCALL" },
	opcode{0, 1, OpArgR, OpArgN, IABC, "TFORLOOP" },
	opcode{0, 1, OpArgU, OpArgU, IABC, "SETLIST " },
	opcode{0, 1, OpArgU, OpArgN, IABC, "CLOSURE " },
	opcode{0, 1, OpArgU, OpArgN, IABC, "VARARG  " },
	opcode{0, 1, OpArgU, OpArgN, IABC, "EXTRAARG" },
}